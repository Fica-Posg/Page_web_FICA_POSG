        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              command: () => {
                this.$router.push("/cursos/formas-pago");
              },
            },
          ],
        },
          ...
          items: [
            {
              ...
              icon: "pi pi-bookmark",
              command: () => {
                this.$router.push("/cursos/historia");
              },
            },
            {
              label: "Noticias",
              icon: "pi pi-globe",
              command: () => {
                this.$router.push("/cursos/noticias");
              },
            },
            {
              label: "Preguntas",
              icon: "pi pi-question",
              command: () => {
                this.$router.push("/cursos/preguntas");
              },
            },
          ],
        },
